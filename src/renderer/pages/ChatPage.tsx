...
import ChatMessageComponent, { stripThinking } from '../components/chat/ChatMessage';
      ...
      <div className="chat-page-sidebar">
        <div className="chat-page-sidebar-header">
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            ...
            <button className="chat-header-btn" onClick={createConversation} title="New Chat">
              <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
        ...
        <div className="chat-page-sidebar-list">
          {conversations.map((conv) => (
            <div
              key={conv.id}
              className={`chat-conversation-item ${conv.id === activeConversationId ? 'active' : ''}`}
        ...
        <div className="chat-page-sidebar-footer">
          ...
          >
            ...
            <option value="vertex" disabled>Vertex AI</option>
          </select>
        </div>
      </div>
        ...
        <div className="chat-page-messages">
          {messages.length === 0 && !isStreaming && (
            <div className="chat-empty chat-empty--page">
              ...
              <h3>AI Cloud Assistant</h3>
              <p>Ask about your cloud resources, costs, security, or optimization opportunities.</p>
              <div className="chat-suggestions">
                <button onClick={() => useChatStore.getState().sendMessage('How many resources did my last scan find?')}>
                  How many resources did my last scan find?
                </button>
                <button onClick={() => useChatStore.getState().sendMessage('Show me my latest assessment grades')}>
                  Show me my latest assessment grades
                </button>
                <button onClick={() => useChatStore.getState().sendMessage('What are my top cost drivers?')}>
